// Package crypto предоставляет общие криптографические функции для клиента и сервера.
package crypto
...
// Формат результата: salt (32 байта) + nonce (12 байт) + ciphertext.
...
// Ожидает формат: salt (32 байта) + nonce (12 байт) + ciphertext.
